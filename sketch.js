...
function draw() {
  ...
  if (gameState == 1) {
    ...
    if (PlayerCar !== 0) {
      ...
      if (PlayerCar == 1) {
        ...
        Player = createSprite(width / 7, height - 100);
        Player.addImage("Lambo", LamboImage);
        AICar1 = createSprite(width / 3,  height -200 );
        AICar1.addImage("Buggati", BugattiImage);
        AICar2 = createSprite(width / 2, height - 100 );
        AICar2.addImage("Ferrari", FerrariImage);
        AICar3 = createSprite(width / 1.5,  height -200 );
        AICar3.addImage("Car", CarImage);
        AICar4 = createSprite(width / 1.177, height - 100 );
      ...
      if (PlayerCar == 5) {
        ...
        AICar3 = createSprite(width / 1.5,  height -200);
        AICar3.addImage("Car", CarImage);
        AICar4 = createSprite(width / 1.177,  height -200 );
  ...
  if (gameState == 2) {
    ...
    heliCopter.addImage(
      "SkyMap/helicopter-removebg-preview.png",
      heliCopterImage
    );
  }
  if (gameState == 3) {
